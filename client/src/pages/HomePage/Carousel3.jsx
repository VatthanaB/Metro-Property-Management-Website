    ...
    return (
        <div>
            <div className="flex flex-col justify-center items-start space-y-10 mt-10">
                <p className="text-[28px] md:text-[28px] ml-4 sm:ml-10 md:ml-72">
                    What Our Client Says
                </p>

            </div>
            <div className="lg:ml-96 ml-14 md:mr-8 space-y-10  mt-10 sm:top-10 right-4 ">
                <p className="text-red-700 text-3xl lg:text-4xl  ">{<BiSolidQuoteAltLeft />}</p>
            </div>
            <div className="inset-0 flex items-center justify-center  ml-8 mr-0 lg:ml-28 ">
                    ...
                    {comments.map((s, i) => (
                        ...
                        >
                            <div className="lg:w-9/12 ">
                                <div className="flex flex-col self-center justify-center items-center lg:items-center  w-5/6 lg:w-full md:w-3/6">
                                    
                                    <div className="w-9/12 md:w-11/12 ">
                                        <p className="text-xl space-y-5 lg:space-y-0">{s.comment}</p>
                                    </div>
            ...
            <div className="flex flex-col self-end items-end right-2 space-y-10 lg:flex lg:self-end lg:items-end md:items-end md:self-end lg:right-2 lg:mr-96 mr-12 md:mr-2">
                <p className="text-red-700 text-3xl lg:text-4xl  ">{<BiSolidQuoteAltRight />}</p>
            </div>
